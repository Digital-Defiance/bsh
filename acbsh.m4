...
dnl
dnl  In no event shall Richard Coleman or the Bsh Development Group be liable
...
dnl  even if Richard Coleman and the Bsh Development Group have been advised of
dnl  the possibility of such damage.
dnl
dnl  Richard Coleman and the Bsh Development Group specifically disclaim any
...
dnl  Bsh Development Group have no obligation to provide maintenance,
